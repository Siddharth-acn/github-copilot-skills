          ...
          <Route path="/" element={
            <div className="card text-center">
              <div className="card-body">
                ...
                <p className="card-text">Track your fitness, join teams, compete on the leaderboard, and more!</p>
                <a href="/activities" className="btn btn-success m-2">View Activities</a>
                <a href="/leaderboard" className="btn btn-info m-2">View Leaderboard</a>
              </div>
            </div>
          } />
        </Routes>
